...
public class ByRateBackgroundOn extends View {

    Paint mInnerPaint;

    public ByRateBackgroundOn(Context context) {
        super(context);
        init();
    }

    public ByRateBackgroundOn(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public ByRateBackgroundOn(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
